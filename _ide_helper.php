 ...
 * Generated for Laravel 5.6.38 on 2018-09-24 04:42:46.
 *
...
namespace Kavenegar\Laravel { 
    ...
    class Facade {
        ...
        {
            return \Kavenegar\KavenegarApi::Send($sender, $receptor, $message, $date, $type, $localid);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::SendArray($sender, $receptor, $message, $date, $type, $localmessageid);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::Status($messageid);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::StatusLocalMessageId($localid);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::Select($messageid);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::SelectOutbox($startdate, $enddate, $sender);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::LatestOutbox($pagesize, $sender);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::CountOutbox($startdate, $enddate, $status);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::Cancel($messageid);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::Receive($linenumber, $isread);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::CountInbox($startdate, $enddate, $linenumber, $isread);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::CountPostalcode($postalcode);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::SendbyPostalcode($sender, $postalcode, $message, $mcistartindex, $mcicount, $mtnstartindex, $mtncount, $date);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::AccountInfo();
        }
        ...
        {
            return \Kavenegar\KavenegarApi::AccountConfig($apilogs, $dailyreport, $debug, $defaultsender, $mincreditalarm, $resendfailed);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::VerifyLookup($receptor, $token, $token2, $token3, $template, $type);
        }
        ...
        {
            return \Kavenegar\KavenegarApi::CallMakeTTS($receptor, $message, $date, $localid);
        }
