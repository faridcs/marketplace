...
//
//ionicons
mix.copy(paths.ionicons + 'docs/css/ionicons.min.css', destVendors + 'ionicons/css');
mix.copy(paths.ionicons + 'docs/fonts', destVendors + 'ionicons/fonts');
//
...
mix.copy(resourcesAssets + 'images', destImages, true);
//
//
// daterange picker
...
mix.copy( srcJs + 'panel.js', destJs);
...
mix.copy( srcJs + 'frontend/frontend.js', destJs + 'frontend');
...
mix.copy(vendors + 'bootstrap-v4-rtl/dist/css/bootstrap-rtl.css', destCss);
mix.copy(vendors + 'bootstrap-v4-rtl/dist/css/bootstrap-rtl.min.css', destCss);

mix.copy(vendors + 'mdbootstrap/css/mdb.css', destCss);
mix.copy(vendors + 'mdbootstrap/css/mdb.min.css', destCss);

// fonts
mix.copy( 'resources/assets/fonts/IranSans-new/IRANSansLight.eot', 'public/assets/fonts/IranSans-new');
mix.copy( 'resources/assets/fonts/IranSans-new/IRANSansLight.ttf', 'public/assets/fonts/IranSans-new');
mix.copy( 'resources/assets/fonts/IranSans-new/IRANSansLight.woff', 'public/assets/fonts/IranSans-new');

// persian DateTimePicker css and js
mix.copy(srcCss + 'jquery.Bootstrap-PersianDateTimePicker.css', destCss);
mix.copy(srcJs + 'jalaali.js', destJs);
mix.copy(srcJs + 'jquery.Bootstrap-PersianDateTimePicker.js', destJs);

// jquery ui autocomplete
mix.copy(srcCss + 'jquery.ui.autocomplete.css', destCss);
mix.copy(srcJs + 'jquery-ui.min.js', destJs);
mix.copy(srcJs + 'jquery-migrate-3.0.0.min.js', destJs);

mix.copy(srcCss + 'request.css', destCss);

mix.combine(
    [
        srcCss + 'fonts.css',
        destCss + 'bootstrap.css',
        destCss + 'bootstrap-rtl.min.css',
